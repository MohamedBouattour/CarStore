...
<!-- Mirrored from demo.themesuite.com/carstore/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Aug 2017 09:53:30 GMT -->
<head>
<meta charset="utf-8">
...
<title>Carstore Car Dealership &amp; Business HTML </title>
<!-- Bootstrap core CSS -->
<link href="<?php echo base_url()."Layout/"; ?>css/bootstrap.min.css" rel="stylesheet">

<!-- HTML5 shiv and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lt IE 9]>
      <script src="<?php echo base_url()."Layout/"; ?>js/html5shiv.js"></script>
      <script src="<?php echo base_url()."Layout/"; ?>js/respond.min.js"></script>
    <![endif]-->

<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Yellowtail%7COpen%20Sans%3A400%2C300%2C600%2C700%2C800" media="screen" />

<link href="<?php echo base_url()."Layout/"; ?>css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
<link rel="stylesheet" href="<?php echo base_url()."Layout/"; ?>css/flexslider.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php echo base_url()."Layout/"; ?>css/jquery.bxslider.css" type="text/css" media="screen" />
<link href="<?php echo base_url()."Layout/"; ?>css/jquery.fancybox.css" rel="stylesheet">
<link href="<?php echo base_url()."Layout/"; ?>css/jquery.selectbox.css" rel="stylesheet">
<link href="<?php echo base_url()."Layout/"; ?>css/style.css" rel="stylesheet">
<link href="<?php echo base_url()."Layout/"; ?>css/mobile.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo base_url()."Layout/"; ?>css/settings.css" media="screen" />
<link href="<?php echo base_url()."Layout/"; ?>css/animate.min.css" rel="stylesheet">
<link href="<?php echo base_url()."Layout/"; ?>css/ts.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.min.js"></script>
<script src="<?php echo base_url()."Layout/"; ?>js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/wow.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/twitter/jquery.tweet.js"></script>
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/twitter/twitter_feed.js"></script> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 left_bar">
                    <ul class="left-none">
                        <li><a href="<?php echo base_url().'home/login' ?>" > <i class="fa fa-user"></i> Login</a></li>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid"> 
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo base_url() ?>"><span class="logo"><span class="primary_text">Carstore</span> <span class="secondary_text"></span></span></a> </div>
...
<div class="back_to_top"> <img src="<?php echo base_url()."Layout/"; ?>images/arrow-up.png" alt="scroll up" /> </div>
<!-- Bootstrap core JavaScript --> 
<script src="<?php echo base_url()."Layout/"; ?>js/retina.js"></script> 
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.parallax.js"></script> 
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.inview.min.js"></script> 
<script src="<?php echo base_url()."Layout/"; ?>js/main.js"></script> 
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.fancybox.js"></script> 
<script src="<?php echo base_url()."Layout/"; ?>js/modernizr.custom.js"></script> 
<script defer src="<?php echo base_url()."Layout/"; ?>js/jquery.flexslider.js"></script> 
<script src="<?php echo base_url()."Layout/"; ?>js/jquery.bxslider.js" type="text/javascript"></script> 
<script src="<?php echo base_url()."Layout/"; ?>js/jquery.selectbox-0.2.js" type="text/javascript"></script> 
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.mousewheel.js"></script> 
<script type="text/javascript" src="<?php echo base_url()."Layout/"; ?>js/jquery.easing.js"></script>
</body>

<!-- Mirrored from demo.themesuite.com/carstore/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Aug 2017 09:53:53 GMT -->
</html>